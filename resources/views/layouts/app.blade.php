...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
        <!-- Sidebar -->
        <div class="fixed left-0 top-0 h-full z-30 w-64 bg-gradient-to-b from-gray-800 to-gray-900 transition-all duration-300 ease-in-out shadow-xl -translate-x-full md:translate-x-0"
            id="sidebar">
            <!-- Sidebar Header -->
            <div class="p-6 border-b border-white/10 flex items-center gap-3">
                <div
                    class="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center text-white font-semibold text-lg">
            ...
            <nav class="py-6">
                <div class="mx-3 mb-1">
                    <a href="{{ route('dashboard') }}"
                        class="flex items-center px-4 py-3 text-white/70 hover:text-white hover:bg-white/10 rounded-lg transition-all duration-200 gap-3 {{ request()->routeIs('dashboard') ? 'bg-blue-500 text-white' : '' }}">
                ...
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex items-center">
                            ...
                            <button
                                class="md:hidden bg-transparent border-none text-gray-500 text-xl cursor-pointer p-2"
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="relative">
                                <button
                                    ...
                                    <span
                                        class="ml-2 text-gray-700 dark:text-gray-300">{{ Auth::user()->name ?? 'User' }}</span>
                                </button>

                                <div class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg hidden z-50"
                                    id="userDropdown">
